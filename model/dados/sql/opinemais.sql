...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Jun-2015 às 13:55
...
(26, 'Tesete', 'bom', 0, 1, 3),
(28, 'Muito ruim, esquenta muito', 'ruim', 0, 3, 3),
(29, 'Esse produto é bom', 'bom', 0, 2, 3),
(30, 'Esse produto é bom', 'bom', 0, 2, 6),
(32, 'Ótimo produto, atende o que eu preciso.', 'bom', 0, 5, 7);
...
(3, 'Note Book  TZ4433', 'Quero comprar o NoteBook AZUS TZ4433 mais não sei se ele é bom. opinem por favor', 'NoteBooks', 'AZUS', '1433686511.jpg', 2, 1, 0, 1),
...
(6, 'Moto X', 'Quero comprar o Moto x, mas não sei se ele é bom. opinem por favor', 'Celulares e SmartPhones', 'Motorola', '1433687458.jpg', 1, 0, 0, 1),
(7, 'Barbeador  r532', 'Opinem sobre esse barbeador, quero compra-lo mais não sei se ele é bom', 'Eletroeletronicos', 'Philips', '1433687801.jpg', 1, 0, 0, 1),
...
INSERT INTO `usuario` (`id_usuario`, `nome`, `email`, `senha`, `foto_perfil`, `status`) VALUES
(1, 'Jackson Daniel', 'jackson.daniel.almeida@gmail.com', '202cb962ac59075b964b07152d234b70', 'user.png', 'ativo'),
(2, 'Ivan Valentim', 'ivanvalentimsantos@gmail.com', '202cb962ac59075b964b07152d234b70', 'user.png', 'ativo'),
(3, 'Eduardo Andrade', 'edurock55@gmail.com', '202cb962ac59075b964b07152d234b70', 'user.png', 'ativo'),
(5, 'Anônimo', 'teste01@teste01', '202cb962ac59075b964b07152d234b70', 'user.png', 'inativo');
...
--
ALTER TABLE `opiniao`
MODIFY `id_opiniao` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=33;
--
